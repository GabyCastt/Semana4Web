...
namespace BibliotecaBDD.Controllers
{
    public class GeneroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdGenero,Nombre,Descripcion,EdadRecomendada,Popularidad")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdGenero,Nombre,Descripcion,EdadRecomendada,Popularidad")] Genero genero)
        {
