...
namespace BibliotecaBDD.Controllers
{
    public class AutorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAutor,Nombre,Apellido,FechaNacimiento,Nacionalidad")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAutor,Nombre,Apellido,FechaNacimiento,Nacionalidad")] Autor autor)
        {
            if (id != autor.IdAutor)
            {
                return NotFound();
